...
DataAcceptor.prototype.paramReloaderTask = function() {
    console.debug('paramReloaderTask()');
    ...
    this.pv.tokValid(b,function(v) {
        if (v) {
            ...
            try {
                ...
                cstate.date = b.date;
                var data_type = b.sensor_data.data_type || '_unknown';
                if (!cstate.sensor_data) cstate.sensor_data = {};
                cstate.sensor_data[data_type] = b.sensor_data;
                cstate['last_' + data_type] = b.date;
