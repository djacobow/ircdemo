...
var app           = express();
var port = process.env.DEMO_PORT || 10001;

var setup_debug_hooks = function(da) {

    var w = function(hname,sname) {
        console.debug('Device action: [' + hname + '] ' + sname);
    };
...
if (require.main === module) {
    ...
    app.use('/demo1/device', devrouter);
    app.use('/demo1/app', approuter);
    app.use('/demo1', toprouter);

    app.listen(port);
    console.log('RadDemo running on port ' + port);
}
